...
abstract class NotesRepository {
  ...
  Future<Either<Failure, void>> addNote(String userId, String title, String contentText, String categoryId);
  Future<Either<Failure, void>> updateNote(String noteId, String title, String contentText, String categoryId);
}
